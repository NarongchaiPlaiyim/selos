 ...
 * generated in the com.tmb.common.data.responsesearchindividualcustomer package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResSearchIndividualCustomer_QNAME = new QName("http://data.common.tmb.com/responseSearchIndividualCustomer", "resSearchIndividualCustomer");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.tmb.common.data.responsesearchindividualcustomer
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://data.common.tmb.com/responseSearchIndividualCustomer", name = "resSearchIndividualCustomer")
