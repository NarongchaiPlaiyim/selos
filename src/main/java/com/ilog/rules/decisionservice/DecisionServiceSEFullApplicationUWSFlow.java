 ...
 * 
 */
@WebService(name = "DecisionServiceSE_Full_Application_UWS_Flow", targetNamespace = "http://www.ilog.com/rules/DecisionService")
@SOAPBinding(parameterStyle = SOAPBinding.ParameterStyle.BARE)
@XmlSeeAlso({
    com.tmbbank.enterprise.model.ObjectFactory.class,
    com.ilog.rules.decisionservice.ObjectFactory.class,
    com.ilog.rules.param.ObjectFactory.class
})
public interface DecisionServiceSEFullApplicationUWSFlow {
     ...
     * @param parameters
     * @return
     *     returns com.ilog.rules.decisionservice.DecisionServiceResponse
