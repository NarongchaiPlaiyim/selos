...
public class MandateDocDetailDAO extends GenericDAO<MandateDocDetail, Long>{
    ...
    public List<MandateDocDetail> findByWorkCasePrescreenIdAndRoleForReturn(long workCasePrescreenId, int roleId) {
    ...
    public List<MandateDocDetail> findByWorkCaseIdAndRole(long workCaseId, int roleId) {
    ...
    public List<MandateDocDetail> findByWorkCasePreScreenIdAndRole(long workCasePreScreenId, int roleId) {
