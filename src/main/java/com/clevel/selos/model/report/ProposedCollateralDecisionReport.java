...
public class ProposedCollateralDecisionReport extends ReportModel{
    ...
    //Sub Collateral
    private List<NewCollateralHeadView> newCollateralHeadViews;
    ...
    public ProposedCollateralDecisionReport() {
        ...
        newCollateralHeadViews = new ArrayList<NewCollateralHeadView>();
    ...
    public List<NewCollateralHeadView> getNewCollateralHeadViews() {
        return newCollateralHeadViews;
    }

    public void setNewCollateralHeadViews(List<NewCollateralHeadView> newCollateralHeadViews) {
        this.newCollateralHeadViews = newCollateralHeadViews;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
                ...
                .append("newCollateralHeadViews", newCollateralHeadViews)
                .toString();
    }
}
