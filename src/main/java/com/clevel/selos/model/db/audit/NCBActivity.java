...
public class NCBActivity implements Serializable {
    @Id
    ...
    public NCBActivity(String userId, String action, String actionDesc, Date actionDate, ActionResult actionResult, String resultDesc, Date resultDate, String linkKey) {
        this.userId = userId;
        this.action = action;
