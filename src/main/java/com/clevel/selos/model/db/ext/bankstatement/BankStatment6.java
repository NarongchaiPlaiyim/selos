...
@Entity
@Table(name = "ext_bankstatment6")
public class BankStatment6 implements Serializable {
    @Id
    @SequenceGenerator(name="SEQ_EXT_BANKSTATMENT6", sequenceName="SEQ_EXT_BANKSTATMENT6", allocationSize=1)
    @GeneratedValue(strategy= GenerationType.SEQUENCE, generator="SEQ_EXT_BANKSTATMENT6")
    private long id;
