...
@Entity
@Table(name = "ext_rlos_cus_detail1")
public class CustomerDetail1 implements Serializable {
    @Id
    private long id;

    @ManyToOne
    @JoinColumn(name="app_ref_number")
    private AppInProcess1 appInProcess1;
    ...
    public AppInProcess1 getAppInProcess1() {
        return appInProcess1;
    }

    public void setAppInProcess1(AppInProcess1 appInProcess1) {
        this.appInProcess1 = appInProcess1;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE)
                .append("id", id)
                .append("appInProcess1", appInProcess1)
