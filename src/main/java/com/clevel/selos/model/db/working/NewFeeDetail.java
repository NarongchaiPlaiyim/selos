...
@Entity
@Table(name = "wrk_new_fee_detail")
public class NewFeeDetail implements Serializable {
    @Id
    @SequenceGenerator(name = "SEQ_WRK_NEW_FEE_DET_ID", sequenceName = "SEQ_WRK_NEW_FEE_DET_ID", allocationSize = 1)
