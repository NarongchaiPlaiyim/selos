...
@Entity
@Table(name = "ext_bankstatment14")
public class BankStatment14 implements Serializable {
    @Id
    @SequenceGenerator(name="SEQ_EXT_BANKSTATMENT14", sequenceName="SEQ_EXT_BANKSTATMENT14", allocationSize=1)
    @GeneratedValue(strategy= GenerationType.SEQUENCE, generator="SEQ_EXT_BANKSTATMENT14")
    private long id;
