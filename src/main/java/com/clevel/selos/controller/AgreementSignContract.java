...
public class AgreementSignContract implements Serializable {
	...
	public void preRender() {
		...
		if (workCaseId > 0) {
			if (!userAccessControl.canUserAccess(Screen.AgreementSign, stepId)) {
	...
	private void _loadFieldControl() {
		...
		List<FieldsControlView> fields = mandatoryFieldsControl.getFieldsControlView(workCaseId, Screen.AgreementSign, ownerCaseUserId);
		fieldMap.clear();
