...
public class RejectLetterService implements Serializable {
    ...
    public void extractRejectedLetterData(String userId, long workCasePreScreenId, long workCaseId) throws Exception{
        log.debug("extractRejectedLetterData() : (userId:{}, workCasePreScreenId: {})",userId,workCasePreScreenId);
        List<Customer> customerBorrowerList = new ArrayList<Customer>();
        String appNumber = "";
        if(workCasePreScreenId!=0){
            WorkCasePrescreen workCasePrescreen = workCasePrescreenDAO.findById(workCasePreScreenId);
            customerBorrowerList = customerDAO.findBorrowerByWorkCasePreScreenId(workCasePreScreenId);
        ...
        if(workCaseId!=0){
            ...
            customerBorrowerList = customerDAO.findBorrowerByWorkCaseId(workCaseId);
        ...
        if(customerBorrowerList!=null && customerBorrowerList.size()>0){
            ...
            rejectedLetter.setAppNumber(appNumber);
