...
public class CreditFacilityTypeLevel implements Serializable {
    ...
    public CreditFacilityTypeLevel() {
    }

    public CreditFacilityTypeLevel(String creditFacilityType, BigDecimal creditLimit, int tenor, String guaranteeType, String loanPurpose) {
