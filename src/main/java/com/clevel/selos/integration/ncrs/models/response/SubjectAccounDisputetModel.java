...
public class SubjectAccounDisputetModel {
    ...
    public SubjectAccounDisputetModel(String disputedate, String disputetime, String disputecode, String disputecodedesc, String disputecoderemark) {
