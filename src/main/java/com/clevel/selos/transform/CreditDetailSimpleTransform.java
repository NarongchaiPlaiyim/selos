...
public class CreditDetailSimpleTransform extends Transform {
	...
	public CreditDetailSimpleView transformToSimpleView(ProposeCreditInfo model) {
	...
	public void updateSimpleView(CreditDetailSimpleView view,ProposeCreditInfo model) {
