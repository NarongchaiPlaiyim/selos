 ...
 * generated in the com.tmbbank.enterprise.model package. 
...
public class ObjectFactory {
    ...
    private final static QName _EGTService_QNAME = new QName("http://www.tmbbank.com/enterprise/model", "EGTService");
    private final static QName _B2ModelRiskScoring_QNAME = new QName("http://www.tmbbank.com/enterprise/model", "B2ModelRiskScoring");
    private final static QName _UnderwritingApprovalResult_QNAME = new QName("http://www.tmbbank.com/enterprise/model", "underwritingApprovalResult");
    private final static QName _UnderwritingApprovalRequest_QNAME = new QName("http://www.tmbbank.com/enterprise/model", "underwritingApprovalRequest");
    private final static QName _CureModelRiskScoring_QNAME = new QName("http://www.tmbbank.com/enterprise/model", "cureModelRiskScoring");
    private final static QName _SmeBehaviorModelRiskScoring_QNAME = new QName("http://www.tmbbank.com/enterprise/model", "smeBehaviorModelRiskScoring");
    private final static QName _ApplicationModelRiskScoring_QNAME = new QName("http://www.tmbbank.com/enterprise/model", "applicationModelRiskScoring");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.tmbbank.enterprise.model
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link EGTServiceType }{@code >}}
     * 
     */
    ...
    public JAXBElement<EGTServiceType> createEGTService(EGTServiceType value) {
        return new JAXBElement<EGTServiceType>(_EGTService_QNAME, EGTServiceType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link B2ModelRiskScoringType }{@code >}}
     * 
     */
    ...
    public JAXBElement<B2ModelRiskScoringType> createB2ModelRiskScoring(B2ModelRiskScoringType value) {
        return new JAXBElement<B2ModelRiskScoringType>(_B2ModelRiskScoring_QNAME, B2ModelRiskScoringType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link UnderwritingApprovalResultType }{@code >}}
     * 
     */
    ...
    public JAXBElement<UnderwritingApprovalResultType> createUnderwritingApprovalResult(UnderwritingApprovalResultType value) {
        return new JAXBElement<UnderwritingApprovalResultType>(_UnderwritingApprovalResult_QNAME, UnderwritingApprovalResultType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link UnderwritingApprovalRequestType }{@code >}}
     * 
     */
    ...
    public JAXBElement<UnderwritingApprovalRequestType> createUnderwritingApprovalRequest(UnderwritingApprovalRequestType value) {
        return new JAXBElement<UnderwritingApprovalRequestType>(_UnderwritingApprovalRequest_QNAME, UnderwritingApprovalRequestType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link CureModelRiskScoringType }{@code >}}
     * 
     */
    ...
    public JAXBElement<CureModelRiskScoringType> createCureModelRiskScoring(CureModelRiskScoringType value) {
        return new JAXBElement<CureModelRiskScoringType>(_CureModelRiskScoring_QNAME, CureModelRiskScoringType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SMEBehaviorModelRiskScoringType }{@code >}}
     * 
     */
    ...
    public JAXBElement<SMEBehaviorModelRiskScoringType> createSmeBehaviorModelRiskScoring(SMEBehaviorModelRiskScoringType value) {
        return new JAXBElement<SMEBehaviorModelRiskScoringType>(_SmeBehaviorModelRiskScoring_QNAME, SMEBehaviorModelRiskScoringType.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ApplicationModelRiskScoringType }{@code >}}
     * 
     */
